    ...
    cardsData.forEach(element => {
        ...
        <div>
                    ...
                    <div class="flex gap-1.5">
                        <div class="badge badge-soft badge-error max-w-[50%]"><i class="fa-solid fa-bug"></i> <span class="text-[12px]">BUG</span></div>
                        <div class="badge badge-soft badge-warning mb-3.5"><i class="fa-regular fa-life-ring"></i>  <span class="text-[12px]">HELP WANTED</span></div>
